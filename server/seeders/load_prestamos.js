...
export async function loadPrestamosToDataBase() {
  ...
  return new Promise((resolve, reject) => {
    fs.createReadStream(rutaArchivo)
      ...
      .on("end", async () => {
        try {
          const sql =
            "INSERT INTO prestamos(id_usuario,isbn,fecha_prestamo,fecha_devolucion,estado) VALUES ?";
      ...
      .on("error", (err) => {
        console.error(
          "Error al leer el archivo CSV de prestamos:",
          err.message
        );
        reject(err);
      });
